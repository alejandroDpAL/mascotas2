...
export const LisMascotas = async (req, res) => {
  try {
...
const uploadImg = multer({ storage: GuardarImg });
export const cargarImagen = uploadImg.single("imagen");



export const RegMascota = async (req, res) => {
  try {
...
const actualizarImg = multer.diskStorage({
  destination: function (req, file, cb) {
    cb(null, "uploads/ImagenActuaizadas");
  },
  filename: function (req, file, cb) {
    cb(null, file.originalname);
  },
});
const uploadsImges = multer({ storage: actualizarImg });
export const actualizarimagenes = uploadsImges.single("imagen");


export const ActuLrMascota = async (req, res) => {
  try {
    const { id } = req.params;
